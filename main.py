...
# --- OPRAVA: DEFINICE TLAČÍTEK PRO AUTENTIZACI (AppAuthView & DashboardAuthView) ---
...
def feedback_reject():
    ...
    if db and fb_id:
        ...
        if d_id and bot.loop and bot.loop.is_running() and bot.is_ready(): asyncio.run_coroutine_threadsafe(send_user_dm(d_id, "❌ Žádost zamítnuta", f"Vaše žádost v aplikace byla administrátorem zamítnuta.\n\n**Důvod:** {reason}", 0xef4444), bot.loop)
